        ...
        <div class="container" style="text-align: center">
            <div>
                ...
                <form action="MotivoServ" method="post"> 
                    ...
                    <input type="text" name="buscarMotivo">
                </form>
            </div>
            <br>
            <div>
                <table class="table table-bordered" style="margin: 0 auto;">
                    ...
                    <tbody>
                        <c:forEach var="motivo" items="${motivo}">
                            <tr>
                                <th class="text-center">${motivo.getCodigoMov()}</th>
                                <th class="text-center">${motivo.getNombreMov()}</th>
                                <th>
                                    <form class="text-center" action="MotivoServ" method="post">
                                        <input type="hidden" name="id" value="${motivo.getCodigoMov()}">
